...
def add_one_smoothing(bigram_bin_size, bigram, trigram_training_file, trigram_probabilities, alpha):
...
def test_alphas(bigram_bin_size, bigram, trigram_training_file, trigram_probabilities):
    ...
    for x in range(0, len(alpha_vals)):
        trigram_probabilities = add_one_smoothing(bigram_bin_size, bigram, trigram_training_file, trigram_probabilities, alpha_vals[x])
...
def main():
    ...
    trigram_probabilities = add_one_smoothing(bigram_bin_size, bigram, trigram_training_file, trigram_probabilities, alpha)
    perplexity            = perplexity_given_tri_counts(trigram_probabilities, trigram_test_file)
