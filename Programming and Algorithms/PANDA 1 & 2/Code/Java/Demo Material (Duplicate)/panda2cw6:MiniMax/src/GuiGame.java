...
import player.OurPlayerFactory;
...
public class GuiGame {
    public static void main(String[] args) {
        ...
        Map<Colour, OurPlayerFactory.PlayerType> typeMap = new HashMap<Colour, OurPlayerFactory.PlayerType>();
        ...
        PlayerFactory factory = new OurPlayerFactory(typeMap, imageFilename, positionsFilename);
